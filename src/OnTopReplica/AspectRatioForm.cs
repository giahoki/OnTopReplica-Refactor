...
namespace OnTopReplica {
    ...
    public class AspectRatioForm : WindowsFormsAero.AeroForm {
        ...
        public void RefreshAspectRatio() {
            ...
            int newHeight = (int)Math.Round((double)(ClientSize.Width - ExtraPadding.Horizontal) / AspectRatio) + ExtraPadding.Vertical;
            ...
            if (newHeight < clientMinimumSize.Height) {
                ...
                newWidth = (int)Math.Round((double)(newHeight - ExtraPadding.Vertical) * AspectRatio) + ExtraPadding.Horizontal;
            }
        ...
        public void AdjustSize(int pixelOffset) {
            ...
            int newHeight = (int)Math.Round((double)(newWidth - ExtraPadding.Horizontal - clientConversionDifference.Width) / AspectRatio) + ExtraPadding.Vertical + clientConversionDifference.Height;
