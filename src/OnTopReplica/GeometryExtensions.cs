    ...
    static class GeometryExtensions {
        ...
        public static Size Fit(this Size sourceSize, Size destinationSize) {
            ...
            if (sourceRatio >= clientRatio) {
                ret = new Size(destinationSize.Width, (int)Math.Round((double)destinationSize.Width / sourceRatio));
            }
            else {
                ret = new Size((int)Math.Round((double)destinationSize.Height * sourceRatio), destinationSize.Height);
            }
